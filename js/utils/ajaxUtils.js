var ajaxUtils = (function() {
    ...
    return {
        ...
        sendEmail: function(data, params) {
            utils.log(data);
            var url = envConfig.apiURL + 'send-notification';
            this.ajax(url, params, 'POST', true, data);
        },
