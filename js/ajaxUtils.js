var ajaxUtils = (function() {
    ...
    return {
        ...
        getCountries: function(params) {
            params = params || null;
            var url = "/data/v1/entity/country";
