...
var UnitplaninfoView = (function() {
    ...
    UnitplaninfoView.prototype = {
        ...
        buildSkeleton: function(containerList) {
            ...
            htmlCode += '<div class="unit-view-tabs">' + '<div class="special-offers">' + '<p><span class="icon icon-smile"></span></p>' + '<p>No Pre-EMI offer and Discount Rs. 4,53,000/</p>' + '</div>' + '<div class="book-com-box">' + '<div class="like-box ' + selectedClass + '">' + '<a >' + '<span class="icon icon-heart"></span>' + '<label class="like-count br50"></label>' + '</a>' + '</div>' + '<div class="book-now">' + '<a >Book online now <span>Rs. ' + data.bookingAmount + '/- (Refundable)</span></a>' + '</div>' + '</div>' + '</div>';
